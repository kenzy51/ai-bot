...
- Keep responses under 15 words.
    ...
    async speak(text) {
        try {
            const audioStream = await this.elevenlabs.textToSpeech.convert('tMXujoAjiboschVOhAnk', { text, model_id: 'eleven_turbo_v2', output_format: 'ulaw_8000' });
            const chunks = [];
